...
//! them. Stage order is fixed (docs/subsystems/pipeline.md); stages can only be enabled/disabled
//! and parameterized.
//!
...
///
/// Field order mirrors the fixed pipeline stage order (docs/subsystems/pipeline.md). Raw decode
