...
## [0.1.0](https://github.com/Capsulsaurus/Focale/releases/tag/focale-core-v0.1.0) - 2026-09-21
...
- *(core)* route export-path transcendentals through pure-Rust libm
- *(core)* flip WB tint sign to match the magenta-positive convention

### Other

- Merge pull request #18 from Capsulsaurus/feat/preview-latency-instrumentation
- correct rawshift blocker claims and the macOS signing decision
